...
# conexion a la base de datos MariaDB usando pymysql y mypy que es para evitar errores comprueba estatica de tipos
...
class PracticalWorkApp(tk.Tk):
    def __init__(self):
        ...
        self.achievement_g1_dropdown.pack(pady=5, ipadx=150)
        ...
        self.achievement_g2_dropdown.pack(pady=5, ipadx=150)
        ...
        self.achievement_g3_dropdown.pack(pady=5, ipadx=150)
    ...
    def submit_grade(self):
        ...
        try:
            # obtener el ID y el nombre del estudiante
        ...
        # preparar asunto y cuerpo del mail
            
            # el cuerpo del email
            email_body = (
                f"Hola! {student_names} esta es una devolución preliminar de tu primer trabajo practico en la materia Concursos y Quiebras.\n\n"
                f"Achievements: {description_g1}, {description_g2}, {description_g3}\n\n"
                "Please review the details."
            )

            # enviar el correo
            FIXED_EMAIL = "useremail@smtp.com"  # define el email fijo
